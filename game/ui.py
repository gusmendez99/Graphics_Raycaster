...
class UI:
    def __init__(self, screen, screen_map, player, clock):
        ...
        # shot SFX
        self.sfx = deque([pygame.image.load(f'./game/sprites/weapons/sfx/{i}.png').convert_alpha() for i in range(9)])
    ...
    def mini_map(self):
        ...
        pygame.draw.line(self.screen_map, YELLOW, (map_x, map_y), (map_x + 8 * math.cos(self.player.angle),
    ...
    def bullet_sfx(self):
        if self.sfx_length_count < self.sfx_length:
            ...
            self.screen.blit(sfx, (HALF_WIDTH - sfx_rect.width // 2, HALF_HEIGHT - sfx_rect.height // 2))
