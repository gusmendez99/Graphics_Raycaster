...
class Sprite:
    def __init__(self, params, position):
        ...
        if self.viewing_angles:
            ...
            self.sprite_positions = {angle: position for angle, position in zip(self.sprite_angles, self.object)}
    ...
    def object_locate(self, player):
        ...
        if 0 <= fake_ray <= FAKE_RAYS_RANGE and self.distance_to_sprite > 30:
            self.projection_height = min(int(PROJECTION_COEFFICIENT / self.distance_to_sprite),
            ...
            sprite_position = (self.current_ray * SCALE - half_sprite_width, HALF_HEIGHT - half_sprite_height + shift)
